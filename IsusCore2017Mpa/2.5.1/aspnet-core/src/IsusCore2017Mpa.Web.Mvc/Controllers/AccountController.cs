...
using IsusCore2017Mpa.Web.Models.Account;
...
using IsusCore2017Mpa.Web.Views.Shared.Components.TenantChange;
using Microsoft.AspNetCore.Identity;

namespace IsusCore2017Mpa.Web.Controllers
{
    public class AccountController : IsusCore2017MpaControllerBase
    {
