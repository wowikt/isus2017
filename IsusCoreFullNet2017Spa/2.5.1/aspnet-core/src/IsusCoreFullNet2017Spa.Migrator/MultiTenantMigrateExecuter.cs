...
using IsusCoreFullNet2017Spa.Migrator;
...
namespace IsusCoreFullNet2017Spa.Migrator
{
    public class MultiTenantMigrateExecuter : ITransientDependency
    {
        ...
        private readonly AbpZeroDbMigrator<IsusCoreFullNet2017SpaDbContext> _migrator;
        private readonly IRepository<Tenant> _tenantRepository;
        private readonly IDbPerTenantConnectionStringResolver _connectionStringResolver;

        public MultiTenantMigrateExecuter(
            AbpZeroDbMigrator<IsusCoreFullNet2017SpaDbContext> migrator,
