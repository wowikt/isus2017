...
namespace IsusCoreFullNet2017Spa.EntityFrameworkCore
{
    ...
    public class IsusCoreFullNet2017SpaEntityFrameworkModule : AbpModule
    {
        ...
        public override void PreInitialize()
        {
            ...
            {
                Configuration.Modules.AbpEfCore().AddDbContext<IsusCoreFullNet2017SpaDbContext>(configuration =>
                {
                    IsusCoreFullNet2017SpaDbContextConfigurer.Configure(configuration.DbContextOptions, configuration.ConnectionString);
                });
            }
        }
