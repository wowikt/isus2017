...
@Injectable()
export class IsusUserServiceProxy {
    private http: Http;
    private baseUrl: string;
    protected jsonParseReviver: (key: string, value: any) => any = undefined;
     ...
     * @return Success
     */
    getAll(skipCount: number, maxResultCount: number, filter: string): Observable<PagedResultDtoOfIsusUserDto> {
        let url_ = this.baseUrl + "/api/services/app/IsusUser/GetAll?";
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            ...
            if (response_ instanceof Response) {
                try {
                    ...
                    return <Observable<PagedResultDtoOfIsusUserDto>><any>Observable.throw(e);
                }
            } else
                return <Observable<PagedResultDtoOfIsusUserDto>><any>Observable.throw(response_);
        });
    }

    protected processGetAll(response: Response): Observable<PagedResultDtoOfIsusUserDto> {
        const status = response.status; 
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PagedResultDtoOfIsusUserDto.fromJS(resultData200) : new PagedResultDtoOfIsusUserDto();
            return Observable.of(result200);
        } else if (status === 401) {
            const _responseText = response.text();
        ...
        return Observable.of<PagedResultDtoOfIsusUserDto>(<any>null);
    }
    ...
    moveToMainUserTable(isusUserId: number): Observable<boolean> {
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processMoveToMainUserTable(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processMoveToMainUserTable(response_);
    ...
    protected processMoveToMainUserTable(response: Response): Observable<boolean> {
        const status = response.status; 
     ...
     * @return Success
     */
    get(id: number): Observable<IsusUserDto> {
        let url_ = this.baseUrl + "/api/services/app/IsusUser/Get?";
        if (id !== undefined)
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            ...
            if (response_ instanceof Response) {
                try {
                    ...
                    return <Observable<IsusUserDto>><any>Observable.throw(e);
                }
            } else
                return <Observable<IsusUserDto>><any>Observable.throw(response_);
        });
    }

    protected processGet(response: Response): Observable<IsusUserDto> {
        const status = response.status; 
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? IsusUserDto.fromJS(resultData200) : new IsusUserDto();
            return Observable.of(result200);
        } else if (status === 401) {
            const _responseText = response.text();
            return throwException("A server error occurred.", status, _responseText, _headers);
        ...
        return Observable.of<IsusUserDto>(<any>null);
    }
}
...
export class PagedResultDtoOfIsusUserDto implements IPagedResultDtoOfIsusUserDto {
    totalCount: number;
    items: IsusUserDto[];

    constructor(data?: IPagedResultDtoOfIsusUserDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (data) {
            ...
            if (data["items"] && data["items"].constructor === Array) {
                ...
                for (let item of data["items"])
                    this.items.push(IsusUserDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PagedResultDtoOfIsusUserDto {
        let result = new PagedResultDtoOfIsusUserDto();
        result.init(data);
        return result;
    }
...
export interface IPagedResultDtoOfIsusUserDto {
    totalCount: number;
    items: IsusUserDto[];
}

export class IsusUserDto implements IIsusUserDto {
    id: number;
    currentName: string;
    ...
    accountName: string;
    accountPwd: string;
    accountPwdMd5: string;
    accountValid: boolean;
    surplusIsTeacher: boolean;
    surplusKlassId: number;
    isDeleted: boolean;
    tmp: number;
    contactInfo: string;
    workYear: number;
    ...
    init(data?: any) {
        if (data) {
            ...
            this.currentShortName = data["currentShortName"];
            this.data = data["data"];
            ...
            this.accountPwd = data["accountPwd"];
            this.accountPwdMd5 = data["accountPwdMd5"];
            this.accountValid = data["accountValid"];
            this.surplusIsTeacher = data["surplusIsTeacher"];
            this.surplusKlassId = data["surplusKlassId"];
    ...
    static fromJS(data: any): IsusUserDto {
        let result = new IsusUserDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["currentShortName"] = this.currentShortName;
        data["data"] = this.data;
        ...
        data["accountPwd"] = this.accountPwd;
        data["accountPwdMd5"] = this.accountPwdMd5;
        data["accountValid"] = this.accountValid;
        data["surplusIsTeacher"] = this.surplusIsTeacher;
        data["surplusKlassId"] = this.surplusKlassId;
