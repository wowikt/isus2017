...
namespace IsusCoreFullNet2017Spa.Migrations
{
    ...
    [Migration("20170918150218_Create_Isus_Tables")]
    partial class Create_Isus_Tables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IsusCoreFullNet2017Spa.Authorization.Users.User", b =>
                {
                    ...
                    b.HasIndex("IsusUserId")
                        .IsUnique()
                        .HasFilter("[IsusUserId] IS NOT NULL");
            ...
            modelBuilder.Entity("IsusCoreFullNet2017Spa.IsusModels.FEducationCla", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnName("uid");
                    ...
                    b.HasIndex("ProgEptId");

                    b.HasIndex("PupilId");

                    b.HasIndex("Id", "ActivityId", "ProgEptId", "CudText", "PupilId")
                        .HasName("IX_FEducationCUD_PupilId");

                    b.ToTable("F_Education_CUD");
                });

            modelBuilder.Entity("IsusCoreFullNet2017Spa.IsusModels.FEducationClaMark", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("uid");
            ...
            modelBuilder.Entity("IsusCoreFullNet2017Spa.IsusModels.SEpt", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("uid");
            ...
            modelBuilder.Entity("IsusCoreFullNet2017Spa.Authorization.Users.User", b =>
                {
                    ...
                    b.HasOne("IsusCoreFullNet2017Spa.IsusModels.IsusUser", "IsusUser")
                        .WithOne("SystemUser")
                        .HasForeignKey("IsusCoreFullNet2017Spa.Authorization.Users.User", "IsusUserId")
            ...
            modelBuilder.Entity("IsusCoreFullNet2017Spa.IsusModels.FEducationClaMark", b =>
                {
                    b.HasOne("IsusCoreFullNet2017Spa.IsusModels.FEducationCla", "EducationCla")
            ...
            modelBuilder.Entity("IsusCoreFullNet2017Spa.IsusModels.FGroupExtraItem", b =>
                {
                    b.HasOne("IsusCoreFullNet2017Spa.IsusModels.FGroupExtra", "GroupExtra")
            ...
            modelBuilder.Entity("IsusCoreFullNet2017Spa.IsusModels.FStudyProgramContent", b =>
                {
                    b.HasOne("IsusCoreFullNet2017Spa.IsusModels.SEpt", "Ept")
                        .WithMany("FStudyProgramsContent")
                        .HasForeignKey("EptId")
                        .HasConstraintName("FK_F_StudyPrograms_Content_S_OPT")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("IsusCoreFullNet2017Spa.IsusModels.FStudyProgram", "StudyProgram")
                        .WithMany("FStudyProgramsContent")
                        .HasForeignKey("FactId")
            ...
            modelBuilder.Entity("IsusCoreFullNet2017Spa.IsusModels.IsusUser", b =>
                {
                    b.HasOne("IsusCoreFullNet2017Spa.IsusModels.WorkYearItem", "WorkYearItem")
                        .WithMany("IsusUsers")
                        .HasForeignKey("WorkYear")
