...
{
    public partial class Create_Isus_Tables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    postfix = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, defaultValueSql: "('')"),
                    prefix = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, defaultValueSql: "('')"),
                    reset_month = table.Column<short>(type: "smallint", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    value_str = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    uid = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Label = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: false),
                    Name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PeriodGroup = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDeleted = table.Column<bool>(type: "bit", nullable: true, defaultValueSql: "((0))"),
                    IsShareable = table.Column<bool>(type: "bit", nullable: true, defaultValueSql: "((0))"),
                    Name = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    ShortName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDeleted = table.Column<bool>(type: "bit", nullable: true, defaultValueSql: "((0))"),
                    SpravName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    group_index = table.Column<int>(type: "int", nullable: true),
                    IsAbstract = table.Column<bool>(type: "bit", nullable: true, defaultValueSql: "((0))"),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: true, defaultValueSql: "((0))"),
                    IsGos = table.Column<bool>(type: "bit", nullable: true, defaultValueSql: "((0))"),
                    Name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    parent = table.Column<int>(type: "int", nullable: false, defaultValueSql: "((0))"),
                    StavkaHours = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    dt_end = table.Column<DateTime>(type: "datetime2", nullable: false),
                    dt_start = table.Column<DateTime>(type: "datetime2", nullable: false),
                    grade_max = table.Column<int>(type: "int", nullable: false),
                    grade_min = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    uid = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Descr = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    HasMainMarks = table.Column<bool>(type: "bit", nullable: true, defaultValueSql: "((1))"),
                    HasSpecialMarks = table.Column<int>(type: "int", nullable: false, defaultValueSql: "((0))"),
                    IsAbstract = table.Column<bool>(type: "bit", nullable: true, defaultValueSql: "((0))"),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: true, defaultValueSql: "((0))"),
                    Name = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    uid = table.Column<int>(type: "int", nullable: false),
                    AutoAffirm = table.Column<bool>(type: "bit", nullable: true, defaultValueSql: "((0))"),
                    Category = table.Column<string>(type: "nvarchar(1)", maxLength: 1, nullable: false),
                    Compatibility = table.Column<int>(type: "int", nullable: false, defaultValueSql: "((1))"),
                    CreatorSolo = table.Column<bool>(type: "bit", nullable: true, defaultValueSql: "((0))"),
                    DirectInput = table.Column<bool>(type: "bit", nullable: true, defaultValueSql: "((1))"),
                    division_id = table.Column<int>(type: "int", nullable: true),
                    IsObsolete = table.Column<bool>(type: "bit", nullable: true, defaultValueSql: "((0))"),
                    IsOrged = table.Column<bool>(type: "bit", nullable: true, defaultValueSql: "((1))"),
                    IsUniqueNum = table.Column<bool>(type: "bit", nullable: true, defaultValueSql: "((1))"),
                    IsYeared = table.Column<bool>(type: "bit", nullable: true, defaultValueSql: "((0))"),
                    ...
                    PermissionMask = table.Column<int>(type: "int", nullable: false, defaultValueSql: "((11))"),
                    ProcContentor = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    ProcDataLoader = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    ProcPoster = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    ProcSaveTrigger = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    ProcValidator = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    ShowInList = table.Column<bool>(type: "bit", nullable: true, defaultValueSql: "((1))")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    account_pwd = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    account_pwd_md5 = table.Column<byte[]>(type: "varbinary(100)", maxLength: 100, nullable: true),
                    account_valid = table.Column<bool>(type: "bit", nullable: true, defaultValueSql: "((0))"),
                    ContactInfo = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    CurrentName = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    CurrentShortName = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    Data = table.Column<string>(type: "xml", nullable: true),
                    Email = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    IsAdmin = table.Column<bool>(type: "bit", nullable: true, defaultValueSql: "((0))"),
                    IsBoss = table.Column<bool>(type: "bit", nullable: true, defaultValueSql: "((0))"),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: true, defaultValueSql: "((0))"),
                    IsDeveloper = table.Column<bool>(type: "bit", nullable: true, defaultValueSql: "((0))"),
                    Photo = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    surplus_IsTeacher = table.Column<bool>(type: "bit", nullable: true, defaultValueSql: "((0))"),
                    surplus_klass_id = table.Column<int>(type: "int", nullable: true),
                    tmp = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    uid = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    IsIntegral = table.Column<bool>(type: "bit", nullable: true, defaultValueSql: "((0))"),
                    marktype_id = table.Column<int>(type: "int", nullable: false),
                    WorkYear = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    uid = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    objectype_id = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    role_descr = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    session = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: false),
                    ActiveWorkYear = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    value_str = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    workyear_marktype_id = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    counter_AuthorRejects = table.Column<int>(type: "int", nullable: false, defaultValueSql: "((0))"),
                    counter_ExpertRejects = table.Column<int>(type: "int", nullable: false, defaultValueSql: "((0))"),
                    counter_Iterations = table.Column<int>(type: "int", nullable: false, defaultValueSql: "((0))"),
                    ...
                    DocNum_Int = table.Column<int>(type: "int", nullable: true),
                    expert_id = table.Column<long>(type: "bigint", nullable: true),
                    FirstProjectDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsAutoNum = table.Column<bool>(type: "bit", nullable: true, defaultValueSql: "((0))"),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: true, defaultValueSql: "((0))"),
                    IsEmpty = table.Column<bool>(type: "bit", nullable: true, defaultValueSql: "((1))"),
                    locker_session = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: true),
                    objectstate_id = table.Column<int>(type: "int", nullable: false),
                    objectype_id = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_A_Objects_Users_Sessions",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    uid = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    IsValid = table.Column<bool>(type: "bit", nullable: true, defaultValueSql: "((0))"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_A_Objects_Validation_Users_Sessions",
                        column: x => x.session,
                        principalTable: "Users_Sessions",
                        principalColumn: "session",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    uid = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    ez_content = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    ez_data = table.Column<string>(type: "xml", nullable: false),
                    ez_date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ez_sigma = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    object_id = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    uid = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    dt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "(getdate())"),
                    object_id = table.Column<int>(type: "int", nullable: false),
                    object_id_out = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    grades = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true, defaultValueSql: "('')"),
                    hours = table.Column<int>(type: "int", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: true, defaultValueSql: "((0))"),
                    IsFrozen = table.Column<bool>(type: "bit", nullable: true, defaultValueSql: "((0))"),
                    IsShareable = table.Column<bool>(type: "bit", nullable: true, defaultValueSql: "((0))"),
                    LeadingFormUD = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    Name = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    OrgForm = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    Result = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SimpleKIM = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SimpleResources = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Target_Developing = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Target_Study = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Target_Teaching = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    uid = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    category = table.Column<string>(type: "nvarchar(1)", maxLength: 1, nullable: false, defaultValueSql: "('E')"),
                    descr = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    fact_id = table.Column<long>(type: "bigint", nullable: true),
                    failtime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    hooked_object_id = table.Column<int>(type: "int", nullable: true),
                    Label = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    paused_object_id = table.Column<int>(type: "int", nullable: true),
                    receiver_id = table.Column<long>(type: "bigint", nullable: false),
                    showtime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Tag = table.Column<int>(type: "int", nullable: true),
                    Txt = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    activity_id = table.Column<int>(type: "int", nullable: false),
                    hours = table.Column<int>(type: "int", nullable: false),
                    mark_exam = table.Column<int>(type: "int", nullable: true),
                    mark_god = table.Column<int>(type: "int", nullable: true),
                    mark_itog = table.Column<int>(type: "int", nullable: true),
                    pupil_id = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    lesson_length = table.Column<int>(type: "int", nullable: false),
                    mark_type = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    mark_value = table.Column<int>(type: "int", nullable: true),
                    pupil_id = table.Column<long>(type: "bigint", nullable: false),
                    time_late = table.Column<int>(type: "int", nullable: false, defaultValueSql: "((0))")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    uid = table.Column<long>(type: "bigint", nullable: false),
                    activity_id = table.Column<int>(type: "int", nullable: false),
                    edu_date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    lesson_volume = table.Column<int>(type: "int", nullable: false),
                    mark_value = table.Column<int>(type: "int", nullable: false),
                    marktype_id = table.Column<int>(type: "int", nullable: false),
                    pupil_id = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    grade = table.Column<int>(type: "int", nullable: false),
                    IsActual = table.Column<bool>(type: "bit", nullable: true, defaultValueSql: "((0))")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    uid = table.Column<long>(type: "bigint", nullable: false),
                    basicgroup_id = table.Column<int>(type: "int", nullable: false),
                    dt_end = table.Column<DateTime>(type: "datetime2", nullable: true),
                    dt_start = table.Column<DateTime>(type: "datetime2", nullable: false),
                    pupil_id = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    plan_end = table.Column<DateTime>(type: "datetime2", nullable: false),
                    plan_start = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ShortWeek = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    dt_end = table.Column<DateTime>(type: "datetime2", nullable: false),
                    dt_start = table.Column<DateTime>(type: "datetime2", nullable: false),
                    essay_count = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    dt_end = table.Column<DateTime>(type: "datetime2", nullable: true),
                    dt_start = table.Column<DateTime>(type: "datetime2", nullable: false),
                    education_id = table.Column<int>(type: "int", nullable: true),
                    IsTeacher = table.Column<bool>(type: "bit", nullable: true, defaultValueSql: "((0))"),
                    position_id = table.Column<int>(type: "int", nullable: false),
                    stavka_norma = table.Column<double>(type: "float", nullable: true),
                    stavka_value = table.Column<double>(type: "float", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    dt_start = table.Column<DateTime>(type: "datetime2", nullable: false),
                    hours = table.Column<int>(type: "int", nullable: false),
                    mark_main = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    uid = table.Column<long>(type: "bigint", nullable: false),
                    activity_id = table.Column<int>(type: "int", nullable: false),
                    basicgroup_id = table.Column<int>(type: "int", nullable: true),
                    dt_start = table.Column<DateTime>(type: "datetime2", nullable: false),
                    essay = table.Column<int>(type: "int", nullable: false, defaultValueSql: "((0))"),
                    extragroup_id = table.Column<int>(type: "int", nullable: true),
                    homework = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    lesson_length = table.Column<int>(type: "int", nullable: false),
                    teacher_id = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    extragroup_id = table.Column<int>(type: "int", nullable: true),
                    hours = table.Column<double>(type: "float", nullable: false),
                    metodist_id = table.Column<long>(type: "bigint", nullable: false),
                    teacher_id = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    uid = table.Column<long>(type: "bigint", nullable: false),
                    activity_id = table.Column<int>(type: "int", nullable: false),
                    cud_text = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    prog_opt_id = table.Column<int>(type: "int", nullable: false),
                    pupil_id = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_WorkYear",
                table: "Users",
                column: "WorkYear");

            migrationBuilder.CreateIndex(
                name: "IX_Users_Organizer_user_id",
                table: "Users_Organizer",
                column: "user_id");
