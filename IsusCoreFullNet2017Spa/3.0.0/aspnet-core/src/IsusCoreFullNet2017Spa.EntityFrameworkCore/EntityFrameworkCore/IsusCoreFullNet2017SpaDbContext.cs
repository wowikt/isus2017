...
namespace IsusCoreFullNet2017Spa.EntityFrameworkCore
{
    public class IsusCoreFullNet2017SpaDbContext : AbpZeroDbContext<Tenant, Role, User, IsusCoreFullNet2017SpaDbContext>
    {
        ...
        public virtual DbSet<FEducationCla> FEducationCud { get; set; }
        public virtual DbSet<FEducationClaMark> FEducationCudMarks { get; set; }
        ...
        public virtual DbSet<SEpt> SOpt { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<FEducationCla>(entity =>
            {
                entity.HasKey(e => e.Id);
                ...
                entity.HasOne(d => d.Fact)
                    .WithOne(p => p.FEducationCla)
                    .HasForeignKey<FEducationCla>(d => d.Id)
                    .HasConstraintName("FK_F_Education_CUD_F");
            });

            modelBuilder.Entity<FEducationClaMark>(entity =>
            {
                entity.HasKey(e => e.Id);
                ...
                entity.HasOne(d => d.EducationCla)
            ...
            modelBuilder.Entity<FStudyProgramContent>(entity =>
            {
                ...
                entity.Property(e => e.EptId).HasColumnName("opt_id");
                ...
                entity.HasOne(d => d.Ept)
                    .WithMany(p => p.FStudyProgramsContent)
                    .HasForeignKey(d => d.EptId)
                    .OnDelete(DeleteBehavior.Restrict)
            ...
            modelBuilder.Entity<SEpt>(entity =>
            {
                entity.HasKey(e => e.Id);
