...
using IsusCoreFullNet2017Spa.Sessions;
using Shouldly;
using Xunit;

namespace IsusCoreFullNet2017Spa.Tests.Sessions
{
    public class SessionAppService_Tests : IsusCoreFullNet2017SpaTestBase
    {
